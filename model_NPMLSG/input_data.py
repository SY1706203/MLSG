...
class InputData:
    ...
    def get_nodes(self, min_count):
        ...
        print("finished reading_graph\n")
        self.G = graph.Graph(nx_G, False, 0.25, 0.25)
        self.G.preprocess_transition_probs()
        self.sentence_length = 0
        self.sentence_count = 0
        print("random walk\n")
        self.walks=graph.simulate_walks(G=self.G,num_walks=10, walk_length=80)
